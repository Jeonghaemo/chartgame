      ...
      try {
        ...
        if (r.ok) {
          ...
          if (data?.game) {
            ...
            if (!ohlcArr) {
              const anchor = typeof ginfo.sliceStartTs === 'number' ? ginfo.sliceStartTs : undefined
              const url1 =
            ...
            writeLocal(
              {
                ...
                sliceStartTs: ginfo.sliceStartTs ?? null,
              },
              {
